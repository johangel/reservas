...
<div style="min-height: 95%" class="container mt-4">
  ...
  <div class="row justify-content-between mt-3">
      ...
      <form>
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <select onchange="showRoleOptions(value)" id="rol" class="form-control" disabled>
        ...
        <div id="optionsContainer" class="hidden">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="inputCity">CMP</label>
              <input type="text" class="form-control" maxlength="6" onkeydown="onlyNumbers(event)" id="CMD">
            </div>

            <div class="form-group col-md-6">
              <label for="inputZip">Salario por consulta</label>
              <input type="number" onkeydown="onlyNumbers(event)" class="form-control" id="salary">
            </div>
          </div>
    ...
    <button type="submit" onclick="updateSpecialistInfo(event)" id="editButton" disabled class="btn btn-primary">Editar rol</button>
  </div>
...
<script type="text/javascript" src="../js/controlers/specialist"></script>
<script type="text/javascript">
  ...
  function updateSpecialistInfo(evt){
    ...
    if(rol == 'Especialista' && (cmd == '' || salary == '' || specializacionField == '' || from == null || to == null || checkSelected == false)){
      toastr.error('llenar todos los campos antes de guardar la informacion');
      return false;
    }
