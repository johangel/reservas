var Specialists = {
  ...
  getAllSpecialists: function(){
    $.ajax({
      type: 'GET',
      async: false,
      url : "http://localhost/reservas/models/Specialists/getAllSpecialists.php",
  ...
  selectSpecialist: function(event, name, id){
    $.ajax({
      type:'GET',
      url : "http://localhost/reservas/models/Specialists/getSpecialistInfo?id="+id,
      success: function(data, status){
        if(data == 'false'){
  ...
  updateSpecialistInfo: function(request, rol){
    $.ajax({
      type: "POST",
      url : "http://localhost/reservas/models/Specialists/updateSpecialistInfo.php",
      data: request,
      success :function(data, status){
        toastr.success(data);
  ...
  setDoctorForReservation: function(doctor_user_id){
    $.ajax({
      type: 'GET',
      url : "http://localhost/reservas/models/Specialists/getSpecialistsReservations?id_specialist="+doctor_user_id,
